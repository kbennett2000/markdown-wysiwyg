...
![The editor with a sample document](images/editor-light.png)
...
![Split view showing rich text and Markdown side by side](images/split.png)
...
![The formatting toolbar](images/toolbar.png)
...
![The editor in dark mode](images/editor-dark.png)
